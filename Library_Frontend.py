...
class Library:
       ...
       #================================================Functions======================================================
              ...
              def Search():
                     with smtplib.SMTP('smtp.gmail.com', 587) as smtp:
                            ...
                            smtp.sendmail("vesit.official@gmail.com",self.surname.get(),msg )
       ...
       #================================================Labels========================================================
              ...
              self.Label_3 = Label(Frame_1, text = 'Name', font = ('arial',13,'bold'), pady = 2, \
                                   bg = 'navajowhite' )
              self.Label_3.grid(row = 2, column = 0, sticky = W)
              self.Label_4 = Label(Frame_1, text = 'EMAIL ID', font = ('arial',13,'bold'), pady = 2, \
                                   bg = 'navajowhite' )
       ...
       #=============================================Buttons=========================================================
              ...
              Button_5 = Button(Button_Frame, text = 'MAIL', font = ('arial',15,'bold'), width = 10, command = Search)
