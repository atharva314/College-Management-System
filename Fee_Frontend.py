    ...
    def __init__(self, master):
        ...
        def Receipt():
            ...
            self.Display.insert(END, '\tStudent Name  :' +
                                self.name.get() + '\n')
            self.Display.insert(END, '\tEmail ID\t          :' +
                                self.admsn.get() + '\n')
            self.Display.insert(
        ...
        def Search():
            with smtplib.SMTP('smtp.gmail.com', 587) as smtp:
                ...
                smtp.sendmail("vesit.official@gmail.com",self.admsn.get(),msg )
        ...
        self.admsn_label = Label(Frame_1, text='Email ID : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        ...
        btnSearch = Button(Button_Frame, text='SEND MAIL', font=(
